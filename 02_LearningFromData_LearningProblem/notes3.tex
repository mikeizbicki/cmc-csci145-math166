...
\begin{align*}
    ...
    \HH{multiaxis2} &= \bigg\{ \x \mapsto \sum_{i=1}^d \sigma_i \sign(x_i) : \sigma_i \in \{+1, -1\} \bigg\}  \\
    \HH{multiaxis3} &= \bigg\{ \x \mapsto \sum_{i=1}^d \sigma_i \sign(x_i) : \sigma_i \in \{+1, 0, -1\} \bigg\}  \\
